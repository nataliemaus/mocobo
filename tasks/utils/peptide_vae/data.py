...
class DatasetKmers(Dataset): # asssuming train data 
    def __init__(self, dataset='train', data_path=None, k=3, vocab=None, vocab2idx=None, load_data=False):
        if data_path is None: 
            # TODO: save vocab so we can avoid re-organizing it from full .csv file every time...
            #       takes ~30 seconds ... 
            path_to_data = '../tasks/utils/peptide_vae/data/uniref-cropped.csv' 
    ...
    def decode(self, tokens):
        ...
        # Only allow valid Amino acids, remove place-holder/uncertainty ones (i.e. "B", "Z")
        temp = []
        for char in protien: 
