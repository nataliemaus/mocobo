...
from tasks.utils.peptide_vae.data import DatasetKmers
...
class InfoTransformerVAE(pl.LightningModule):
    ...
    def sample_prior(self, n):
        if self.bottleneck_size is None:
            # unsure what to do there, seq len doesn't exist anymore
    ...
    def decode(self, z, tokens, as_probs=False):
        ...
        # Later: Mask out all stop tokens but the first?
